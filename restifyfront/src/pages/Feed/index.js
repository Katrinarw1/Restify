...
const Feed = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:8000/feed/?page=${page}`, {
            method: 'GET',
            headers: {
    ...
    return (
        <main className="blog-section feed spad mt-4">
                        ...
                        <div className="col-xxl-4 col-xl-6 col-6" key={result.id}>
                            <div className="single-blog">
                                <div className="blog-img-container">
                                    <img src={result.header_image != null ? result.header_image : "/images/cupcakes.jpg"}
                                        className="img-fluid" />
                                </div>
                                <div className="blog-post px-3 pb-3">
                                    <div className="d-flex blog-details justify-content-center">
                                        <div className="flex-fill text-center px-0 mx-0">
                                            <Link to={`/${result.restaurant_owner}/restaurant/general`} className="restaurant-link">
